						...
						<div class="span12">
							...
							<div class="row-fluid">
								<h3 class="header smaller lighter blue">
									<i class="icon-edit"></i> カテゴリ情報を確認してください。
								</h3>
								<form class="form-horizontal" role="form" id="input-form" method="POST" action="{{ url('category/createfinish') }}">
    								...
    								<div class="form-actions">
    									<button class="btn btn-inverse" type="button" onclick="javascript:submitForm('#input-form', '{{ url('/category/create') }}');"><i class="icon-circle-arrow-left bigger-110"></i>戻る</button>&nbsp;&nbsp;&nbsp;
