        ...
        $(".manager_href").addClass('active');
				...
				<div class="breadcrumbs" id="breadcrumbs">
					...
					<ul class="breadcrumb">
						...
						<li class="active">運営者の新規登録（確認）</li>
					</ul><!--.breadcrumb-->
				</div>
						...
						<div class="span12">
							...
							<div class="row-fluid">
								<h3 class="header smaller lighter blue">
									<i class="icon-edit"></i> 運営者情報を確認してください。
								</h3>
								<form class="form-horizontal" role="form" id="input-form" method="POST" action="{{ url('manager/createfinish') }}">
    								...
    								<div class="control-group">
    									...
    									<div class="controls">
    										{{{ str_repeat('●', strlen($record['password'])) }}}
    									</div>
    								</div>
    								...
    								<div class="form-actions">
    									<button class="btn btn-inverse" type="button" onclick="javascript:submitForm('#input-form', '{{ url('/manager/create') }}');"><i class="icon-circle-arrow-left bigger-110"></i>戻る</button>&nbsp;&nbsp;&nbsp;
