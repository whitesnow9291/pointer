						...
						<div class="span12">
							...
							<div class="row-fluid">
								<h3 class="header smaller lighter blue">
									<i class="icon-edit"></i> 運営者情報の変更内容を入力してください。
								</h3>
								<form class="form-horizontal" role="form" id="input-form" method="POST" action="{{ url('manager/editconfirm') }}">
    								...
    								<div class="control-group">
    									...
    									<div class="controls">
    										...
    										<span class="help-inline">※パスワードを変更しない場合、入力しないでください。</span>
    								...
    								<div class="form-actions">
    									...
    									<a href="{{ url('/manager/edit?id=' . $record['id']) }}" class="btn" type="reset"><i class="icon-undo bigger-110"></i>リセット</a>&nbsp;&nbsp;&nbsp;
    									<a class="clear_form_href btn" type="reset"><i class="class="icon-trash bigger-110"></i>クリア</a>&nbsp;&nbsp;&nbsp;
