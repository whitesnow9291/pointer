...
(function($) {
		...
		init : function(options, swfUploadOptions) {
			...
			return this.each(function() {
				...
				var settings = $.extend({
					...
					buttonText      : '参照',     // The text to use for the browse button
	...
	var handlers = {
		...
		onUploadSuccess : function(file, data, response) {
			//rgb start
			file_name=new String(data);
			startpos=file_name.lastIndexOf('\\');
			temp=file_name.lastIndexOf('/');
			if (startpos<temp){
				startpos=temp;
			}
			endpos=parseInt(data.length-1);
			file_name=data.slice(startpos+1,endpos);
			$('#new_uploaded_file_name_input').val(file_name);
			pos=$('#pointer_photo_table_id tbody tr[pos]').length;
			image_file_name=$('#new_uploaded_file_name_input').val();
			   html="<tr pos="+pos+">"+
				"<td class='index_td'>"+
				"</td>"+
				"<td class='image_td'>"+
					"<ul class='ace-thumbnails'>"+
						"<li>"+
							...
							"<div class='tools tools-bottom'>"+
								"<a>"+
									"<i class='image_update_icon icon-pencil'></i>"+
								"</a>"+
								"<a>"+
				...
				"</td>"+
				"<td class='col-sm-10'>"+
					"<textarea class='photo_comment  col-xs-12' ></textarea>"+
				"</td>"+
				"<td  class='col-sm-2'>"+
