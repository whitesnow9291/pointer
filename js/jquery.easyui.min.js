...
var _40=$(e.data.target).offset();//alert("441");
...
var _1d5=_1d3.children("div.panel-body");//alert(_1d5._outerWidth());
if(_1d2){
if(_1d2.width){
...
_1d3.css({left:opts.left,top:opts.top});//alert("2449");
if(!isNaN(opts.width)){
...
var paddingValue = 0;
//
if (_1d1.id == "pointer_add_option_panel") {
	paddingValue = 0;
} else if (_1d1.id == "search_result_table") {
	paddingValue = 10;
}
//
_1d4.add(_1d5)._outerWidth(_1d3.width()-paddingValue);
if(!isNaN(opts.height)){//alert("2457");
_1d3._outerHeight(opts.height);
var marginBottomValue = 0;
_1d5._outerHeight(_1d3.height()-_1d4._outerHeight() - marginBottomValue);
}else{//alert("2461");
_1d5.height("auto");
}
//
if (_1d1.id == "search_result_table") {
	var cur_outer_width = _1d5._outerWidth();
	var new_outer_width = cur_outer_width - 22;
	_1d5.css({width: new_outer_width});
}
if (_1d1.className == "panel-body") {
	var cur_outer_height = _1d5._outerHeight();
	var new_outer_height = cur_outer_height - 29;
	_1d5.css({height: new_outer_height});
}
//
_1d3.css("height","");
...
_1d9.css({left:opts.left,top:opts.top});//alert("2479");
...
if(_1fd==true){//alert("cccccccccccc");
...
if(!$.data(_1ff,"panel").original){//alert("2730");
...
_235.mask=$("<div class=\"window-mask\"></div>").insertAfter(_235.window);//alert("3064");
...
_23b.pmask=$("<div class=\"window-proxy-mask\"></div>").insertAfter(_23b.window);//alert("3117");
...
},onResize:function(e){//alert("3125");
_23b.proxy.css({left:e.data.left,top:e.data.top});
_23b.proxy._outerWidth(e.data.width);
_23b.proxy._outerHeight(e.data.height);
return false;
},onStopResize:function(e){//alert("3130");
...
function _238(){
if(document.compatMode=="BackCompat"){//alert("3140");
return {width:Math.max(document.body.scrollWidth,document.body.clientWidth),height:Math.max(document.body.scrollHeight,document.body.clientHeight)};
}else{//alert("3142");
return {width:Math.max(document.documentElement.scrollWidth,document.documentElement.clientWidth),height:Math.max(document.documentElement.scrollHeight,document.documentElement.clientHeight)};
}
};
$(window).resize(function(){//alert("3146");
$("body>div.window-mask").css({width:$(window)._outerWidth(),height:$(window)._outerHeight()});
setTimeout(function(){//alert("3148");
...
var _252=$(_249);
_24a.panel("panel").show();//alert("3288");
...
var _27d=_27a[i];
_27d.panel("header")._outerHeight(_27c);//alert("3562");
...
_2cd.children("div.tabs-tool").remove();//alert("3870");
...
var _2dc=opts.height=="auto"?"auto":_2da.height();//alert("3937");
...
var _33a=_334(pp);//alert("4411");
pp.panel("resize",{width:_33a,height:cpos.height-29,left:cc.width()-_33a,top:cpos.top+8});
cpos.width-=_33a;
};
...
if(_355=="east"){//alert("4640");
var _35f=_357["east"].panel("options");//alert("4641");
return {resizeC:{width:_35e.width+_35f.width-28},expand:{left:cc.width()-_35f.width},expandP:{top:_35e.top+8,left:cc.width()-28,width:28,height:_35e.height-10},collapse:{left:cc.width(),top:_35e.top+8,height:_35e.height}};//{resizeC:{width:_35e.width+_35f.width-28},expand:{left:cc.width()-_35f.width},expandP:{top:_35e.top,left:cc.width()-28,width:28,height:_35e.height},collapse:{left:cc.width(),top:_35e.top,height:_35e.height}};
}else{
if(_355=="west"){
var _360=_357["west"].panel("options");//alert("4645");
...
if(_33d(_357.expandEast)){//alert("4659");
_357.expandEast.panel("resize",{top:28,height:hh});
}
if(_33d(_357.expandWest)){//alert("4662");
...
if(_33d(_357.south)) {
//hh-=$(".panel-header")[0].clientHeight+3;
}
}//alert("4675");//alert(hh);alert("_355: "+_355);
_357.east.panel("resize",{top:32,height:hh-$(".panel-header")[0].clientHeight-3});
...
if(_363=="east"&&_364.expandEast){//alert("4708");
return {collapse:{left:cc.width(),top:_368.top+8,height:_368.height},expand:{left:cc.width()-_364["east"].panel("options").width}};//{collapse:{left:cc.width(),top:_368.top,height:_368.height},expand:{left:cc.width()-_364["east"].panel("options").width}};
}else{
if(_363=="west"&&_364.expandWest){//alert("4714");
return {collapse:{left:-_364["west"].panel("options").width,top:_368.top,height:_368.height},expand:{left:0}};
}else{
if(_363=="north"&&_364.expandNorth){//alert("4717");
return {collapse:{top:-_364["north"].panel("options").height,width:cc.width()},expand:{top:0}};
}else{
if(_363=="south"&&_364.expandSouth){//alert("4720");
...
if(_36b.east.length&&_36b.east.panel("options").collapsed){//alert("4737");
_353(_36a,"east",0);
}
